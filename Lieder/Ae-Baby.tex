\beginsong{Baby}[
    wuw={Die Ärzte},
    alb={Runter mit den Spendierhosen...},
    jahr={2000},
]
...
\[Hm] Müssen sie wirklich für uns \[A]sterben?
Ich sag \[E]Baby, nein, sie müs\[G]sen nicht. \[A]
\endverse
...
\beginverse
\[Hm] Das dicke, dicke Kind der \[A]Nachbarn schreit stunden\[G]lang vor deiner Tür.
\echo{draußen vor \[A]deiner schönen \[(Hm)]Tür}
\[Hm] Gib ihm ein Über\[A]raschungsei und du kriegst \[E]frisches Fleisch dafür.\[G]
\echo{lecker \[A]Kinderbeinchen}
\[Hm] Wenn dein Chef dir auf die \[A]Nerven geht, lad ihn \[G]mal zum Essen ein.
\echo{Schluss mit der ewi\[A]gen Arschkrieche\[(Hm)]rei}
...
Aus artgerechter ^Haltung, sag mir, was ^könnte besser ^sein? \[Hm] \[G] \[A] \[D] \[C\#]
\endchorus
...
Gib Schweinen eine \[D]Chance, \[Hm] Gib Schweinen eine \[G]Chance. \[A] \break
Gib Schweinen eine ^Chance, lass die armen ^Rinder in Ruh.
...
dann sorgt ein bisschen ^Chili dafür, dass du ihn ^nie mehr ver\[A7]gisst.
\endchorus

\beginverse*
\[E] \hspace{11pt} Und jetzt seh ich dich erbleichen, weil äh,
\[C\#m] in meinem Kühlschrank siehst du Leichenteile.
\[A] \hspace{13pt}Doch ich lass dich noch ein Weilchen heile,
\[H7] \hspace{6pt} bevor ich dich mit meinem Beil zerteile.
