\beginsong{Die Moorsoldaten}[
    ...
    meljahr={1933},
    txt={Wolfgang Langhoff, Johann Esser},
    txtjahr={1933}, 
    bo={420}, 
    pfii={68}, 
    pfiii={42}, 
...
\beginchorus
\lrep \[D]Dann \[G]zieh'n wir Moorsol\[Am]daten \[Em]nicht mehr mit dem \[H7]Spaten in's \[Em]Moor! \rrep
\endchorus

\endsong

\beginscripture{}
Das Lied entstand 1933 im Konzentrationslager Börgermoor (im Emsland), in dem hauptsächlich politische Gefangene untergebracht waren. Obwohl die Lagerleitung es schnell verbot, wurde das Singen des Liedes von einigen Wachleuten toleriert. Es wurde auch in anderen Moorlagern gesungen und von entlassenen Häftlingen verbreitet, sodass es sogar der Moskauer Rundfunk zu Ehren deutscher Antifaschisten spielte.
\endscripture
